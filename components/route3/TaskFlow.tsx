...
export function TaskFlow() {
  ...
  return (
    <section id="task" className="space-y-10">
      ...
      <div id="r3-stage4">
        <h3 className="text-h3 text-ink">{TASK3.stage4.heading}</h3>
        <p className="mt-1 text-caption text-ash">{TASK3.stage4.instructions}</p>
        <div className="mt-4"><HorizonSequencer /></div>
      </div>

      <div id="r3-stage5">
        <h3 className="text-h3 text-ink">{TASK3.stage5.heading}</h3>
        <div className="mt-4"><BridgeToHelix /></div>
      </div>

      <div id="r3-stage6">
        <h3 className="text-h3 text-ink">{TASK3.stage6.heading}</h3>
        <p className="mt-1 text-caption text-ash">{TASK3.stage6.instructions}</p>
        <div className="mt-4"><HelixProposalBuilder /></div>
      </div>

      <div id="r3-stage7">
        <h3 className="text-h3 text-ink">{TASK3.stage7.heading}</h3>
        <p className="mt-1 text-caption text-ash">{TASK3.stage7.instructions}</p>
