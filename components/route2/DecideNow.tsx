...
/**
 * Exercise 5 — the decision that cannot wait: the decision, the assumption,
 * the falsifier, and the cost of one more quarter. Free text, so no live
 * check; the mentor key carries the assessment criteria and worked
...
export function DecideNow() {
  ...
  return (
    <section id={domId.decide} className="scroll-mt-24 space-y-4 rounded-2xl border border-line bg-paper p-5">
      <ExerciseHeader n={DECIDE_NOW_EXERCISE.n} title={DECIDE_NOW_EXERCISE.title} minutes={DECIDE_NOW_EXERCISE.minutes} intro={DECIDE_NOW_EXERCISE.intro} material={DECIDE_NOW_EXERCISE.material} />
