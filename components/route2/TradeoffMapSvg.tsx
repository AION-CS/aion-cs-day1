 ...
 *
 * The slide is a CSS transform transition on the group; in SVG a CSS px
 * translate is measured in user units, so it scales with the viewBox.
 */
        ...
        return (
          <g key={q.id}>
            ...
            <text
              x={r.x + 12}
              y={r.y + 24}
              className={warm ? "fill-accent" : "fill-ash"}
