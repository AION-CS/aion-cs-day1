...
/**
 * The task — four exercises on the left, the board memo assembling on the right
 * (a sticky strip on mobile). No exercise gates another.
 */
    ...
    <section id={domId.task} className="scroll-mt-24 space-y-6">
      ...
      <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <LivePanel
          ...
          summary={`${r2.ranking.length}/${RANK_SLOTS} decisions · ${r2.placedCount}/${MAP_MEASURES.length} measures mapped`}
        >
          <BoardMemo />
        </LivePanel>
      </div>
