/**
 * Route 2 — Management Decision (L3). All learner-facing copy and pure data
...
export const R2 = {
  ...
  /** cardId → quadrant id. */
  quadrant: (cardId: string) => `r2:quad:${cardId}`,
  /** roleId+letter → checked. */
  raci: (roleId: string, letter: RaciLetter) => `r2:raci:${roleId}:${letter}`,
  decideNow: "r2:decide",
...
export const PAGE_INTRO = {
  tag: "ROUTE 2 — DECISION ARCHITECTURE",
...
export const MATERIAL: MaterialSection[] = [
  ...
  },
  {
    ...
    callout: {
      ...
      text: "The task's RACI check enforces the structural rule only — exactly one Accountable. It will not tell you which role should hold which letter, because that is the judgement the exercise is for.",
    },
    references: [
  ...
  },
  {
    ...
    callout: {
      ...
      text: "A pilot that works, a report that reads well, and nothing different in procurement, operations or planning twelve months later. Every step of the task is aimed at that specific outcome.",
    },
    references: [
...
// ---------------------------------------------------------------------------
// The task — CodeVista Digital Platforms.
// ---------------------------------------------------------------------------
...
export const TASK2 = {
  ...
  nameField: {
    label: "Your name",
    instruction: "Used to label the exported memo — it becomes e.g. \"1-jane-day11-l3task1\".",
